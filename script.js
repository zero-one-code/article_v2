...
function createVaccinePinLayer() {
    ...
    const sourceCard = makeVaccineCard(
        "Here, we walk through herpes zoster cases and serious adverse events in vaccinated and placebo groups of adults aged 60 and older, per 1,000 people over 3.1 years.",
        "vaccine-card-source",
...
function createMobileHeroLayer() {
    ...
    const title = makeElement("h1", "title main-title intro-main-title", "How Effective and Safe is<br>the Herpes Zoster<br>Vaccine?");
    setBox(title, 310, 245, 1300);
    content.appendChild(title);
    ...
    setBox(description, 410, 600, 1100);
...
function updateMobileHeroLayer(currentDesignY) {
    ...
    const firstPinnedScene = document.querySelector(".effectiveness-scrolly");
    const firstSceneTop = firstPinnedScene !== null
        ? parseFloat(firstPinnedScene.dataset.absoluteTop || "900")
        : 900;
...
function renderIntro() {
    const mainTitle = makeElement("h1", "title main-title intro-main-title", "How Effective and Safe is<br>the Herpes Zoster<br>Vaccine?");
    appendElement("intro", mainTitle, 310, 245, 1300);
    ...
    appendElement("intro", description, 410, 600, 1100);
    ...
    appendElement("intro", source, 455, 742, 1010);

    addScrollButton("intro");
}

function renderEffectiveness() {
    addEffectivenessIntroScene("effectiveness", 900);
}

function renderEffectivenessRange() {
    addEffectivenessRangeScrollScene('effectivenessRange', 9400);
}
